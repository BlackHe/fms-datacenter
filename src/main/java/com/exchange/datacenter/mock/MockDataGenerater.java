...
public class MockDataGenerater {
    ...
    public static List<Trade> tradeList() {
        ...
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("ETH_BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("XRP_BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("LTC_BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("23223").setClientId("0000000022").setCoinName("EOS_BTC").setDirection("1").setFee("1").setId("938279318").setTradingDate("2020-01-04 00:00:00").setRegisteredName("sss23@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("USDT_BTC").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB_BTC").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB_USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("ETH_USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("EOS_USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB_USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("22ds2ddd3@163.com"));
        return trades;
    }
