...
public class MockDataGenerater {
    ...
    public static List<Trade> tradeList() {
        ...
        trades.add(new Trade().setAmount("29392.121221").setClientId("0000000021").setCoinName("BTC-ETH").setDirection("1").setFee("0.827338").setId("92382329238").setTradingDate("2020-01-01 00:00:00").setRegisteredName("2ds223@163.com"));
        trades.add(new Trade().setAmount("23.2").setClientId("0000000021").setCoinName("USDT-ETH").setDirection("1").setFee("1.283392").setId("72837283273").setTradingDate("2020-01-01 01:00:00").setRegisteredName("222ss3@163.com"));
        trades.add(new Trade().setAmount("938.1921831").setClientId("0000000021").setCoinName("CYB-ETH").setDirection("1").setFee("0.1").setId("322232123421").setTradingDate("2020-01-02 00:00:00").setRegisteredName("2gddd223@163.com"));
        trades.add(new Trade().setAmount("923.983121221").setClientId("0000000021").setCoinName("EOS-ETH").setDirection("1").setFee("2").setId("93837287372").setTradingDate("2020-01-03 00:00:00").setRegisteredName("dddfd2223@163.com"));
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("ETH-BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("XRP-BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("21123.2").setClientId("0000000021").setCoinName("LTC-BTC").setDirection("0").setFee("0.283392").setId("72837283273").setTradingDate("2020-01-01 11:00:00").setRegisteredName("ddd2223@163.com"));
        trades.add(new Trade().setAmount("23223").setClientId("0000000022").setCoinName("EOS-BTC").setDirection("1").setFee("1").setId("938279318").setTradingDate("2020-01-04 00:00:00").setRegisteredName("sss23@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("USDT-BTC").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB-BTC").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB-USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("ETH-USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("EOS-USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("222ddd3@163.com"));
        trades.add(new Trade().setAmount("222.022").setClientId("0000000022").setCoinName("CYB-USDT").setDirection("0").setFee("1.9").setId("827328328323").setTradingDate("2020-01-05 00:00:00").setRegisteredName("22ds2ddd3@163.com"));
        return trades;
    }
